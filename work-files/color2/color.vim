...
syntax match NeoMuttColorCommand /\v<color>/
...
hi NeoMuttColorCommand       guibg=#ff0000
hi NeoMuttSimpleObject       guibg=#ffff00
hi NeoMuttPatternObject      guibg=#ff00ff
hi NeoMuttRegexObject        guibg=#00ffff
hi NeoMuttRegexBackrefObject guibg=#80ff80
hi NeoMuttColorDescription   guibg=#ff80ff
hi NeoMuttAttribute          guibg=#80ffff
hi NeoMuttNumber0to255       guibg=#8080ff
